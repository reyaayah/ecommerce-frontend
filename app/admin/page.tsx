...
export default function DashboardPage() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#E0EFF6]/30 via-white to-[#E0EFF6]/20 p-8">
            {/* Header */}
            <div className="mb-8">
                <h2 className="text-3xl font-bold text-[#70908B] mb-2">
                    Dashboard
                </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-[#C4C4C4]/20 p-6">
                    <h3 className="text-lg font-bold text-[#70908B] mb-6">
                        Quick Stats
                    </h3>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between pb-4 border-b border-[#E0EFF6]">
                            ...
                            <span className="text-lg font-bold text-[#70908B]">23</span>
                        </div>
                        <div className="flex items-center justify-between pb-4 border-b border-[#E0EFF6]">
                        ...
                        <div className="flex items-center justify-between pb-4 border-b border-[#E0EFF6]">
                            ...
                            <span className="text-lg font-bold text-[#70908B]">47</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-sm text-slate-600">Conversion Rate</span>
                            <span className="text-lg font-bold text-green-500">3.2%</span>
                        </div>
                    </div>
                </div>
            </div>
